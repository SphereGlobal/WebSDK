...
const LoginButton = ({ onClick, buttonProps, imageProps, isLogoDark }) => {
    var _a;
    return (react_1.default.createElement("button", Object.assign({ onClick: (_a = buttonProps.onClick) !== null && _a !== void 0 ? _a : onClick }, buttonProps),
