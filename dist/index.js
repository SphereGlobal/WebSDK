...
var _WebSDK_credentials,
  _WebSDK_environment,
  _WebSDK_oauth2Client,
  _WebSDK_wrappedDek,
  _WebSDK_wrappedDekExpiration,
  _WebSDK_domainDev,
  _WebSDK_audienceDev,
  _WebSDK_domainProd,
  _WebSDK_audienceProd,
  _WebSDK_domain,
  _WebSDK_audience,
  _WebSDK_pwaDevUrl,
  _WebSDK_pwaStagingUrl,
  _WebSDK_pwaProdUrl,
  _WebSDK_createRequest,
  _WebSDK_fetchUserBalances,
  _WebSDK_fetchUserWallets,
  _WebSDK_fetchUserInfo,
  _WebSDK_fetchUserNfts,
  _WebSDK_getWrappedDek,
  _WebSDK_fetchTransactions;
Object.defineProperty(exports, '__esModule', { value: true });
exports.LoginButton =
  exports.LoginBehavior =
  exports.SupportedChains =
  exports.SphereEnvironment =
    void 0;
const types_1 = require('./src/types');
const oidc_client_ts_1 = require('oidc-client-ts');
const utils_1 = require('./src/utils');
var types_2 = require('./src/types');
Object.defineProperty(exports, 'SphereEnvironment', {
  enumerable: true,
  get: function () {
    return types_2.Environments;
  },
});
var types_3 = require('./src/types');
Object.defineProperty(exports, 'SupportedChains', {
  enumerable: true,
  get: function () {
    return types_3.SupportedChains;
  },
});
...
Object.defineProperty(exports, 'LoginButton', {
  enumerable: true,
  get: function () {
    return LoginButton_1.LoginButton;
  },
});
class WebSDK {
  constructor() {
    ...
    this.setEnvironment = (environment = types_1.Environments.PRODUCTION) => {
      ...
      if (
        environment === types_1.Environments.DEVELOPMENT ||
        environment === types_1.Environments.STAGING
      ) {
        __classPrivateFieldSet(
          this,
          _WebSDK_domain,
          __classPrivateFieldGet(this, _WebSDK_domainDev, 'f'),
          'f'
        );
        __classPrivateFieldSet(
          this,
          _WebSDK_audience,
          __classPrivateFieldGet(this, _WebSDK_audienceDev, 'f'),
          'f'
        );
      } else {
        __classPrivateFieldSet(
          this,
          _WebSDK_domain,
          __classPrivateFieldGet(this, _WebSDK_domainProd, 'f'),
          'f'
        );
        __classPrivateFieldSet(
          this,
          _WebSDK_audience,
          __classPrivateFieldGet(this, _WebSDK_audienceProd, 'f'),
          'f'
        );
      }
      return this;
    ...
    this.handleAuth = () =>
      __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
          const authResult = yield (_a = __classPrivateFieldGet(
            this,
            _WebSDK_oauth2Client,
            'f'
          )) === null || _a === void 0
          ...
          if (authResult) {
            ...
            if (this.user) {
              ...
              this.user = {
                uid: (_c = authResult.profile) === null || _c === void 0 ? void 0 : _c.sub,
              };
    ...
    this.handlePersistence = () =>
      __awaiter(this, void 0, void 0, function* () {
        var _d, _e, _f;
        const persistence = yield (_d = __classPrivateFieldGet(this, _WebSDK_oauth2Client, 'f')) ===
          null || _d === void 0
          ? void 0
          : _d.getUser();
        if (persistence) {
    ...
    this.login = () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (this.loginType === types_1.LoginBehavior.REDIRECT) {
          yield (_g = __classPrivateFieldGet(this, _WebSDK_oauth2Client, 'f')) === null ||
          _g === void 0
            ? void 0
            : _g.signinRedirect({
          ...
          try {
            const authResult = yield (_h = __classPrivateFieldGet(
              this,
              _WebSDK_oauth2Client,
              'f'
            )) === null || _h === void 0
    ...
    this.logout = () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          if (typeof window === 'undefined') return;
          (_k = __classPrivateFieldGet(this, _WebSDK_oauth2Client, 'f')) === null || _k === void 0
            ? void 0
            : _k.signoutSilent();
          (_l = __classPrivateFieldGet(this, _WebSDK_oauth2Client, 'f')) === null || _l === void 0
            ? void 0
            : _l.removeUser();
    ...
    _WebSDK_createRequest.set(this, (method = 'GET', body = {}, headers = {}) =>
      __awaiter(this, void 0, void 0, function* () {
        var _m;
        ...
        myHeaders.append(
          'Authorization',
          `Bearer ${
            (_m = __classPrivateFieldGet(this, _WebSDK_credentials, 'f')) === null || _m === void 0
              ? void 0
              : _m.accessToken
          }`
        );
    ...
    _WebSDK_fetchUserBalances.set(this, () =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const requestOptions = yield __classPrivateFieldGet(
            this,
            _WebSDK_createRequest,
            'f'
          ).call(this);
    ...
    _WebSDK_fetchUserWallets.set(this, () =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const requestOptions = yield __classPrivateFieldGet(
            this,
    ...
    _WebSDK_fetchUserInfo.set(this, () =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const requestOptions = yield __classPrivateFieldGet(
            this,
    ...
    _WebSDK_fetchUserNfts.set(this, () =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const requestOptions = yield __classPrivateFieldGet(
            this,
    ...
    _WebSDK_getWrappedDek.set(this, () =>
      __awaiter(this, void 0, void 0, function* () {
        console.log(
          __classPrivateFieldGet(this, _WebSDK_wrappedDek, 'f'),
          __classPrivateFieldGet(this, _WebSDK_wrappedDekExpiration, 'f') * 1000,
          Date.now(),
          'is expired',
          __classPrivateFieldGet(this, _WebSDK_wrappedDekExpiration, 'f') * 1000 < Date.now()
        );
        if (
          __classPrivateFieldGet(this, _WebSDK_wrappedDek, 'f') &&
          __classPrivateFieldGet(this, _WebSDK_wrappedDekExpiration, 'f') * 1000 > Date.now()
        ...
        try {
          ...
          if (data.data) {
            ...
            __classPrivateFieldSet(
              this,
              _WebSDK_wrappedDekExpiration,
              (yield (0, utils_1.decodeJWT)(__classPrivateFieldGet(this, _WebSDK_wrappedDek, 'f')))
                .exp * 1000,
              'f'
            );
          }
    ...
    _WebSDK_fetchTransactions.set(this, () =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const requestOptions = yield __classPrivateFieldGet(
            this,
      ...
      __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          const requestOptions = yield __classPrivateFieldGet(
            ...
            'POST',
            { chargeData: charge },
            { 'x-api-key': (_o = this.apiKey) !== null && _o !== void 0 ? _o : '' }
          );
    ...
    this.pay = ({ toAddress, chain, symbol, amount, tokenAddress }) =>
      __awaiter(this, void 0, void 0, function* () {
        const payFn = () =>
          __awaiter(this, void 0, void 0, function* () {
            const wrappedDek = yield __classPrivateFieldGet(this, _WebSDK_getWrappedDek, 'f').call(
              this
            );
        ...
        const payChargeFn = () =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const requestOptions = yield __classPrivateFieldGet(
              ...
              _WebSDK_createRequest,
              'f'
            ).call(this, 'POST', { wrappedDek, transactionId });
            const response = yield fetch(`${this.baseUrl}/pay`, requestOptions);
            return yield response.json();
          });
        try {
    ...
    this.getWallets = (forceRefresh) => {
      var _a;
      return this.checkTokenAndExecuteFunction(
        __classPrivateFieldGet(this, _WebSDK_fetchUserWallets, 'f'),
        (_a = this.user) === null || _a === void 0 ? void 0 : _a.wallets,
        forceRefresh
      );
    };
    this.getUserInfo = (forceRefresh) => {
      var _a;
      return this.checkTokenAndExecuteFunction(
        __classPrivateFieldGet(this, _WebSDK_fetchUserInfo, 'f'),
        (_a = this.user) === null || _a === void 0 ? void 0 : _a.info,
        forceRefresh
      );
    };
    this.getBalances = (forceRefresh) => {
      var _a;
      return this.checkTokenAndExecuteFunction(
        __classPrivateFieldGet(this, _WebSDK_fetchUserBalances, 'f'),
        (_a = this.user) === null || _a === void 0 ? void 0 : _a.balances,
        forceRefresh
      );
    };
    this.getNfts = (forceRefresh) => {
      var _a;
      return this.checkTokenAndExecuteFunction(
        __classPrivateFieldGet(this, _WebSDK_fetchUserNfts, 'f'),
        (_a = this.user) === null || _a === void 0 ? void 0 : _a.nfts,
        forceRefresh
      );
    };
    this.getTransactions = (
      ...
      __awaiter(this, void 0, void 0, function* () {
        ...
        const encoded = yield this.checkTokenAndExecuteFunction(
          __classPrivateFieldGet(this, _WebSDK_fetchTransactions, 'f'),
          (_p = this.user) === null || _p === void 0 ? void 0 : _p.transactions,
          forceRefresh
        );
        ...
        if (!getReceived)
          response = transactions.filter((t) => {
            var _a;
            return t.receiverUid !== ((_a = this.user) === null || _a === void 0 ? void 0 : _a.uid);
          });
        // if getSent is set to false, only get the transactions that have "receiverUid"
        if (!getSent)
          response = transactions.filter((t) => {
            var _a;
            return t.senderUid !== ((_a = this.user) === null || _a === void 0 ? void 0 : _a.uid);
          });
    ...
    this.isTokenExpired = () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (!__classPrivateFieldGet(this, _WebSDK_credentials, 'f')) {
          const user = yield (_q = __classPrivateFieldGet(this, _WebSDK_oauth2Client, 'f')) ===
            null || _q === void 0
            ? void 0
            : _q.getUser();
          if (user) {
        ...
        return (
          (_r = __classPrivateFieldGet(this, _WebSDK_credentials, 'f')) === null || _r === void 0
            ? void 0
            : _r.expires_at
        )
          ? __classPrivateFieldGet(this, _WebSDK_credentials, 'f').expires_at <
    ...
    this.refreshToken = () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          const user = yield (_s = __classPrivateFieldGet(this, _WebSDK_oauth2Client, 'f')) ===
            null || _s === void 0
            ? void 0
            : _s.getUser();
          if (
            ((_t = __classPrivateFieldGet(this, _WebSDK_credentials, 'f')) === null || _t === void 0
              ? void 0
              : _t.expires_at) &&
            ((_u = __classPrivateFieldGet(this, _WebSDK_credentials, 'f')) === null || _u === void 0
              ? void 0
              : _u.expires_at) > Math.floor(Date.now() / 1000)
          ) {
            return user;
          }
          if (
            !((_v = __classPrivateFieldGet(this, _WebSDK_credentials, 'f')) === null ||
            _v === void 0
              ? void 0
              : _v.refreshToken) &&
            user
          ...
          if (
            (_w = __classPrivateFieldGet(this, _WebSDK_credentials, 'f')) === null || _w === void 0
              ? void 0
              : _w.refreshToken
          ) {
            const userRefreshed = yield (_x = __classPrivateFieldGet(
              this,
              _WebSDK_oauth2Client,
              'f'
            )) === null || _x === void 0
    ...
    this.checkTokenAndExecuteFunction = (fn, property = undefined, forceRefresh = false) =>
      __awaiter(this, void 0, void 0, function* () {
...
(_WebSDK_credentials = new WeakMap()),
  (_WebSDK_environment = new WeakMap()),
  (_WebSDK_oauth2Client = new WeakMap()),
  (_WebSDK_wrappedDek = new WeakMap()),
  (_WebSDK_wrappedDekExpiration = new WeakMap()),
  (_WebSDK_domainDev = new WeakMap()),
  (_WebSDK_audienceDev = new WeakMap()),
  (_WebSDK_domainProd = new WeakMap()),
  (_WebSDK_audienceProd = new WeakMap()),
  (_WebSDK_domain = new WeakMap()),
  (_WebSDK_audience = new WeakMap()),
  (_WebSDK_pwaDevUrl = new WeakMap()),
  (_WebSDK_pwaStagingUrl = new WeakMap()),
  (_WebSDK_pwaProdUrl = new WeakMap()),
  (_WebSDK_createRequest = new WeakMap()),
  (_WebSDK_fetchUserBalances = new WeakMap()),
  (_WebSDK_fetchUserWallets = new WeakMap()),
  (_WebSDK_fetchUserInfo = new WeakMap()),
  (_WebSDK_fetchUserNfts = new WeakMap()),
  (_WebSDK_getWrappedDek = new WeakMap()),
  (_WebSDK_fetchTransactions = new WeakMap());
