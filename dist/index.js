...
class WebSDK {
    constructor(clientId, redirectUri, apiKey, loginType = types_1.LoginBehavior.REDIRECT) {
        ...
        _WebSDK_handleAuth.set(this, (url, state) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                if (state) {
        ...
        this.handleCallback = (url, state) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const handleAuth = yield __classPrivateFieldGet(this, _WebSDK_handleAuth, "f").call(this, url, state);
                if (handleAuth)
